...
class neuron : #will hopefully be the building block for a neural network
    ...
    def update(self) :
        ...
        if len(self.soma.signalBuildupMemory) > 9 :
